...
-   Make progress on your analysis and write-up in `report.qmd`:
...
set.seed(123)
teams = tibble(section = rep(1,4),your_team_name = paste0("team-",1:4),
               team_to_review = paste0("team-",sample(1:4,4)))
```
