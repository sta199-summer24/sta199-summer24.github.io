...
## Interpreting a 1% increase in regression output {.smaller}
...
$$
\begin{aligned}
\widehat{interest\;rate} = {}& 9.93 +5.34 \times \big(credit \; utilization + 1/100 \big)\\
= {}& 9.93 +5.34 \times credit \; utilization + 5.34 \times 1/100\\
= {}& 9.93 +5.34 \times credit \; utilization + 0.0534
\end{aligned}
$$
